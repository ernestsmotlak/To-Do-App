...
const User = () => {
  ...
  const str =
    "I am going to try to put this shitty database on my server, if it breaks, it breaks, what can you do hehe. what the fuck else am i supposed to do. I";
  const str2 =
    "I am going to try to put this shitty database on my server, if it breaks";
        ...
        <div className="container">
          ...
          {addTaskButtonClicked ? (
            <AddTask
              ...
              sendDataToParent={isTaskButtonClicked}
            />
          ) : null}
              ...
              <div className="task">
                {tasks.map((task, index) => (
                  <div key={index}>
                    ...
                    <div className="container mb-2 no-padding-right">
                      ...
                      <div className="row max-height60">
                        <div className="col-9  d-flex justify-content-center align-items-center">
                          {task.TaskName.length > 46
                            ? task.TaskName.substring(0, 46) + "..."
                            : task.TaskName}
                        </div>
                    ...
                    <i>&nbsp;</i>
                    <i
                      className="update-button bi bi-arrow-clockwise"
